...
<title>View Issued raw material </title>
...
<%
 	List<IssueRaw>issueRaws=(List<IssueRaw>)request.getAttribute("issueRawList");
%>
<div class="login-container">
	<h2 style="color:#F2125E;">View Issued raw material </h2>
<table>
<tr>
	<th>Id</th>
	<th>Raw Id</th>
