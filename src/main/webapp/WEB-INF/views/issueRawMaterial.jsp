 ...
 <div class="login-container">
  ...
  <h2>Issue Raw Material</h2>
		<form action="issueRawMaterial" method="post">
			...
			<input type="text" name="id" placeholder="Enter material's id">
			<input type="text" name="rawId" placeholder="Enter raw material's id">
			<input type="text" name="rawName" placeholder="Enter raw material's name">
			...
			<input style="background-color:#F2125E; color:white" type="submit" value="Issue Material">
		</form>
</div>
</div>
</body>
